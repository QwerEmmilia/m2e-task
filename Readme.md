...
Вітаю. Нижче я залишив текст автора чий [репозиторій](https://github.com/ger86/symfony-docker) я склонував, щоб мати symfony-docker.

Я робив все в PhpStorm та на Windows 10.
